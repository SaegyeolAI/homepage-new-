          ...
          <div className="contact-grid">
            <div className="info">
              ...
              <p style={{marginTop:18, color:"var(--text-2)"}}>
                AI 에이전트 보안 도입을 검토 중이시거나, K-AgentSec PoC가 필요하다면
                아래 양식으로 직접 문의해 주세요. 영업일 기준 1일 내 회신드립니다.
              </p>
              <div className="contact-meta">
                <div className="row"><span className="k">EMAIL</span><span className="mono">contact@saegyeol.kr</span></div>
